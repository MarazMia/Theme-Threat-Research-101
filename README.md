...
This finding from image ([E.2](#E.2)) suggests that, as the event mainly happened in the European regions, a significant portion of the websites are also registered from this area as TLDs like .eu (European Union), .ch (Switzerland), .nl (Netherlands), .uk (United Kingdom), .at (Austria), .dk (Denmark), and .fr(France) are from the European side.
